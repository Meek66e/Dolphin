...
// Serial Console Messages
	...
	#define MSG_M115_REPORT "FIRMWARE_NAME:Mantaray V1" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) " UUID:" MACHINE_UUID "\n"
